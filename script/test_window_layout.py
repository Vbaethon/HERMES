...
progress = source[source.index("@MainActor\nfinal class DownloadTaskProgressBarView"):source.index("@MainActor\nfinal class DownloadProgressStackView")]
...
@main enum Check {
 @MainActor static func main() {
  ...
  NSLayoutConstraint.activate([
   ...
   bar.bottomAnchor.constraint(equalTo: controller.view.bottomAnchor,constant: -40), bar.heightAnchor.constraint(equalToConstant: 28)
  ])
