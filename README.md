...
## 1.8 / 0609：正式版本号更新（2026-09-16）

将本轮审计修复的正式版本号调整为 1.8，构建号递增为 0609；功能代码与通过回归的 0608 相同。Release 构建与签名验证通过，已安装到 `/Applications/HERMES.app`。安装前后 83 条完成记录、45 条下载合成记录哈希一致。旧版及偏好备份：`/Users/long/Library/Application Support/HERMES/Backups/1.7-0608-before-1.8-0609-20260916-103851`。日志保存在 `Build/Release-1.8-0609/`。
